...
public class Book {
	...
	void 도서대여( String loginid ) {
		...
		System.out.println(" 도서 ISBN : ");	String isbn = BookApplication.scanner.next();
	...
	void 도서등록() {
		...
		System.out.print(" 도서명 : ");	String bname = BookApplication.scanner.next();
		System.out.print(" 작가 : ");	String bwriter = BookApplication.scanner.next();
		//*중복체크[isbn]
		for( Book temp : BookApplication.books ) {
			if(  temp !=null && temp.ISBN.equals(isbn) ) {
